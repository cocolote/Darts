...
function refreshList(players, game_id) {
  ...
  playersHTML.push('<li class="row table-row">');
  ...
  playersHTML.push('<h6 class="table-columns small-1 column delete">');
  ...
  for(var i = 0; i < players.length; i++) {
    ...
    playersHTML.push('<h6 class="table-columns small-2 column points-numbers">');
